...
const LoginLanding = () => {
  ...
  const portalOptions = [
    ...
    },
    {
      ...
      description:
        "View Your Profile, Track Attandance, Request Time Off and Access Payslips.",
      icon: UserIcon,
    },
  ];
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
        <div className="w-full max-w-md animate-fade-in relative z-10">
            ...
            {portalOptions.map((portal) => (
              ...
              >
                <div className="relative z-10 flex item-center justify-between gap-4 sm:gap-5">
                  <h3 className="text-lg text-slate-800 group-hover:tet-indigo-600 mb-1 transition-colors">
                    {portal.title}
                  </h3>
          ...
          <div className="mt-12 text-center md:text-left text-sm text-slate-400">
            <p>© {new Date().getFullYear()} Emplora. All Rights Reserved</p>
          </div>
        </div>
      </div>
    </div>
